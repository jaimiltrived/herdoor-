...
class _MillsListScreenState extends State<MillsListScreen> {
  ...
  List<FlourMill> _allMills = MockData.mills;
  ...
  void _applyFilter() {
    ...
    setState(() {
      _filteredMills = _allMills.where((mill) {
        final matchesQuery = query.isEmpty ||
            mill.name.toLowerCase().contains(query) ||
            mill.specialty.toLowerCase().contains(query) ||
            mill.address.toLowerCase().contains(query);
        final matchesCategory = _selectedCategory == 'All' ||
            mill.specialty.toLowerCase().contains(_selectedCategory.toLowerCase()) ||
            mill.name.toLowerCase().contains(_selectedCategory.toLowerCase());
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text('Listening for mill or grain name...'),
                ...
                // Mills List
                if (_isLoading && _filteredMills.isEmpty)
                  const Center(
                    child: Padding(
                ...
                else if (_filteredMills.isEmpty)
                  Center(
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'No flour mills found for "$_selectedCategory"',
                            style: GoogleFonts.plusJakartaSans(
                              fontSize: 15,
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: Image.network(
                                          ...
                                          errorBuilder: (context, error, stackTrace) => Container(
                                            ...
                                            width: double.infinity,
                                            color: AppTheme.surfaceWarm,
                                            child: const Icon(Icons.storefront, color: AppTheme.primaryTerracotta, size: 40),
                                          ),
                                        ),
                                      ),
                                    ),
